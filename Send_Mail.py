...
class GUI:
    def __init__(self, master):
        ...
        # # creating from label-entries
        # self.from_label = tk.Label(self.master, text='From', bg='grey')
        # self.from_label.grid(row=2, column=0, sticky='nsew')
        # self.from_entry = tk.Entry(self.master)
        # self.from_entry.grid(row=2, column=1, sticky='nsew')

        # creating to label-entries
        self.to_label = tk.Label(self.master, text='To', bg='grey')
        self.to_label.grid(row=3, column=0, sticky='nsew')
        self.to_entry = tk.Entry(self.master)
        self.to_entry.grid(row=3, column=1, sticky='nsew')

        # creating subject label-entries
        self.subject_label = tk.Label(self.master, text='Subject', bg='grey')
        self.subject_label.grid(row=4, column=0, sticky='nsew')
        self.subject_entry = tk.Entry(self.master)
        self.subject_entry.grid(row=4, column=1, sticky='nsew')

        # creating content label-entries
        self.content_label = tk.Label(self.master, text='Content', bg='grey')
        self.content_label.grid(row=5, column=0, sticky='nsew')
        self.content_entry = tk.Entry(self.master)
        self.content_entry.grid(row=5, column=1, sticky='nsew')
        ...
        self.button_send.grid(row=6, column=0, columnspan=2)
